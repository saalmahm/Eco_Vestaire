  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto p-4 sm:p-6 transition-all duration-300">
        ...
        <h1 className="text-lg sm:text-xl font-bold text-gray-800">Gestion des Commandes</h1>
        <p className="text-sm sm:text-base text-gray-600 font-semibold">Suivez toutes les transactions sur la plateforme</p>
