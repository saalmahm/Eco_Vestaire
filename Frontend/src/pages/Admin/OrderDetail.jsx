    ...
    if (loading) {
        return (
            <div className="flex h-screen bg-gray-50">
                <div className={`w-64 bg-green-800 text-white transition-all duration-300 ease-in-out sm:block ${sidebarOpen ? 'block' : 'hidden'} sm:block`}>
                    <Sidebar />
                </div>
    ...
    if (!order) {
        return (
            <div className="flex h-screen bg-gray-50">
                ...
                <div className="flex-1 flex justify-center items-center">
                    <div className="text-center p-8">Commande non trouvée</div>
                </div>
            </div>
        );
    }
        ...
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="flex-1 overflow-auto p-4 sm:p-6 transition-all duration-300">
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h1 className="text-lg sm:text-xl font-bold text-gray-800">Détails de la Commande #{order.id}</h1>
