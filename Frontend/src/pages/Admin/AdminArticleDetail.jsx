        ...
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="flex-1 overflow-auto p-4 sm:p-6 transition-all duration-300">
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h1 className="text-lg sm:text-xl font-bold text-gray-800">Détails de l'Article</h1>
                        <p className="text-sm sm:text-base text-gray-600 font-semibold">Informations complètes sur l'article</p>
                    </div>
