      ...
      <div className="bg-gray-50 min-h-screen py-8 px-8 md:px-16 w-full mt-12">
        <div className="w-full">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-5 w-full md:flex md:items-center md:space-x-6">
              <div className="w-28 h-28 bg-gray-100 rounded overflow-hidden mb-4 md:mb-0">
                <img
                  src="/sneakers.png"
              ...
              <div className="flex-1">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="font-semibold text-lg mb-1">Veste en Jean Vintage</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-5 w-full md:flex md:items-center md:space-x-6">
              ...
              <div className="flex-1">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="font-semibold text-lg mb-1">Sneakers Blanches</h3>
